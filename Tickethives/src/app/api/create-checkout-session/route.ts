...
import { englandVsArgentinaSeats, finalMatchSeats, franceVsSpainSeats, thirdPlacePlayoffSeats } from "@/data/seatListings";
import { getMatchById } from "@/data/matches";

const seatPricesByMatch: Record<string, number[]> = {
  "match-101": franceVsSpainSeats.map((listing) => listing.price),
